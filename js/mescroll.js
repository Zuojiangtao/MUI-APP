...
function getListData(page){
	$.ajax({
        ...
        success: function(data){
			...
			mescroll.endSuccess(data.length);//如果传了参数,mescroll会自动判断列表如果无任何数据,则提示空;列表如果无下一页数据,则提示无更多数据;如果不传参数则仅隐藏加载中的状态
			//设置列表数据
			//setListData(data);
        },
        error: function(data){
...
MeScroll.prototype.initDownScroll = function() {
	...
	//鼠标或手指的按下事件
	me.scrollDom.addEventListener("touchstart", touchstartEvent,false); //移动端手指事件
	//me.scrollDom.addEventListener("dragstart", touchstartEvent);
	me.scrollDom.addEventListener("mousedown", touchstartEvent,false); //PC端鼠标事件
	...
	//鼠标或手指的滑动事件
	me.scrollDom.addEventListener("touchmove", touchmoveEvent,false); //移动端手指事件
	//me.scrollDom.addEventListener("drag", touchmoveEvent);
	me.scrollDom.addEventListener("mousemove", touchmoveEvent,false); //PC端鼠标事件
	...
	//鼠标或手指的离开事件
	me.scrollDom.addEventListener("touchend", touchendEvent,false); //移动端手指事件
	//me.scrollDom.addEventListener("dragend", touchendEvent);
	me.scrollDom.addEventListener("mouseup", touchendEvent,false); //PC端鼠标抬起事件
	me.scrollDom.addEventListener("mouseleave", touchendEvent,false); //PC端鼠标离开事件
